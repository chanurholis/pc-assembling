        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="col-12 mt-4">
                    ...
                    <form action="<?= base_url('master/aksi_monitor') ?>" method="post">
                        ...
                        <a style="height:40px;" class="btn btn-secondary float-right mr-3 mt-1" href="<?= base_url('master/monitor') ?>"><i class="far fa-arrow-alt-circle-left text-light"></i> Kembali</a>
                    </form>
                </div>
            </div>
