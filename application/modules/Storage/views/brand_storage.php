            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <a href="<?= base_url('Storage/tambah_brand_storage') ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Brand Storage</a>
                        <div class="box-tools">
                            ...
                            foreach ($storage as $s) : ?>
                                <tr>
                                    ...
                                    <td scope="row" class="text-center">
                                        <a href="<?= base_url('Storage/ubah_brand_storage/') . $s->brand_storage_id ?>"><span class="label label-info"><i class="fa fa-pencil"></i> Ubah</span></a>
                                        <a class="tombol-hapus" href="<?= base_url('Storage/hapus_brand_storage/') . $s->brand_storage_id ?>"><span class="label label-danger"><i class="fa fa-trash"></i> Hapus</span></a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </table>
